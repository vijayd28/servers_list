...
final class Version20201025133424 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE servers (id INT AUTO_INCREMENT NOT NULL, uuid VARCHAR(36) NOT NULL, model_name VARCHAR(100) NOT NULL, ram_size VARCHAR(20) NOT NULL, ram_type VARCHAR(10) NOT NULL, hdd_size VARCHAR(20) NOT NULL, hdd_type VARCHAR(10) NOT NULL, location VARCHAR(100) NOT NULL, price VARCHAR(20) NOT NULL, currency VARCHAR(10) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
